...
def punto_central(poly1, poly2):
    lat_central = (poly1[0] + poly2[0]) / 2
    lon_central = (poly1[1] + poly2[1]) / 2
    return (lat_central, lon_central)

list_file_path = ['DHM - Trackers CT4-5.kml']
...
for file_path in list_file_path:
    ...
    for placemark in root.findall('.//kml:Placemark', namespaces):
        ...
        if yawprom > 180 * 1.05 or yawprom < 180 * 0.95:
            ...
            distancia_promedio = (distancia1 + distancia2) / 2
            # centro entre poly1 y poy2
            centro1 = punto_central(poly1, poly2)
            print("Centro 1: ", centro1)
            centro2 = punto_central(poly3, poly4)
            print("Centro 2: ", centro2)
            distancia_centro = haversine_distance(centro1[0], centro1[1], centro2[0], centro2[1])
            print("Distancia entre centros: ", distancia_centro)
        ...
        updated_data.append({
            ...
            'polyCentro1': f"{centro1[0]},{centro1[1]}",
            'polyCentro2': f"{centro2[0]},{centro2[1]}",
